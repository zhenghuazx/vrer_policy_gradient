...
from vrer_policy_gradient.base import BaseAgent, OffPolicy, OnPolicy
from vrer_policy_gradient.cli import Executor
from vrer_policy_gradient.utils.buffers import ReplayBuffer1, ReplayBuffer2
from vrer_policy_gradient.utils.cli import (agent_args, non_agent_args, play_args,
...
@pytest.fixture(params=[item['agent'] for item in vrer_policy_gradient.agents.values()])
def agent(request):
    """
    Fixture with agents available in rlalgorithms_tf2.agents
    Args:
        request: _pytest.fixtures.SubRequest
...
@pytest.fixture(params=[agent_id for agent_id in vrer_policy_gradient.agents])
def agent_id(request):
    """
    Fixture with agent ids available in rlalgorithms_tf2.agents
    Args:
        request: _pytest.fixtures.SubRequest
...
@pytest.fixture(params=[command for command in vrer_policy_gradient.commands])
def command(request):
    """
    Fixture with commands available in rlalgorithms_tf2.commands
    Args:
        request: _pytest.fixtures.SubRequest
