...
from vrer_policy_gradient import A2C, PPO, TRPO
...
from vrer_policy_gradient.utils.common import (create_buffers, create_models,
                                           get_wandb_key, write_from_dict)
...
class TestBase:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('Freeway-ramDeterministic-v0', 'CarRacing-v1'),
        ],
    )
    ...
    def test_play(
        ...
        """
        Play 1 game, and ensure resulting frames are saved.
        Args:
            agent: OnPolicy/OffPolicy subclass.
            capsys: _pytest.capture.CaptureFixture
            tmp_path: pathlib.PosixPath
        ...
        models = create_models(vrer_policy_gradient.agents[agent_id], envs[0], agent_id)
        ...
        agent.play(False, frame_dir, 0, max_steps)
