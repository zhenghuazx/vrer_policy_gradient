...
from vrer_policy_gradient.tests.utils import (assert_flags_displayed,
                                          get_expected_flags)
from vrer_policy_gradient.utils.common import create_model
...
class TestExecutor:
    ...
    def test_maybe_create_agent_command_agent(self, command, agent_id, capsys):
        ...
        Args:
            command: One of the commands available in rlalgorithms_tf2.commands
            agent_id: One of the agent ids available in rlalgorithms_tf2.agents
            capsys: _pytest.capture.CaptureFixture
        """
    ...
    def test_create_models(self, agent_id):
        ...
        for model_type in ['model', 'actor_model', 'critic_model']:
            if model_type in rlalgorithms_tf2.agents[agent_id]:
        ...
        [
            {
                ...
                'non_agent': {
                    ...
                    'agent': vrer_policy_gradient.A2C,
                    'lr': 0.555,
                    'opt_epsilon': 0.3,
                    'beta1': 15,
                    'beta2': 12,
