...
from vrer_policy_gradient.utils.common import write_from_dict
...
class BaseAgent(ABC):
    ...
    def concat_buffer_samples(self, weights=None):
        """
        ...
        if hasattr(self, 'buffers'):
            ...
            for i, env in enumerate(self.envs):
                ...
                if weights is None:
                    batch = buffer.get_weighted_sample(weights)
                else:
    ...
    def play(
        ...
        os.makedirs(frame_dir or '.', exist_ok=True)
        while True:
